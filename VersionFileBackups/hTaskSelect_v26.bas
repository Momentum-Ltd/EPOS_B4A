...
'	Private btnConfig As B4XView				' Config button (only shown in test mode)
'	Private btnConnection As B4XView			' Connection (used to leave centre).
...
#End If
	...
	' Local variables
'	Private origConnectText As String			' Storage for original connection button caption.
