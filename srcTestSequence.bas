...
#Region  Documentation
	...
	' Release...: 1
	' Created by: D Morris
	' Details...: Based on svcTestSequence_4 (renamed also 'p' and 'l' usage dropped).
	'
	' Date......: 
	' Release...: 
	' Overview..:
...
Public Sub StartTestSequence(initArgs As TestSeqInitialiseArgs)
