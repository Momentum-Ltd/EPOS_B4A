...
#Region  Documentation
	...
	' Date......: 26/11/20
	' Release...: 11
	' Overview..: More support for item size.
	' Amendee...: D Morris.
	' Details...: Added: GetSizeTextForSizePriceValue().
	'			    Mod: GetGroupCatName() and GetMainCatName() return return warning text if not found.
	'
	' Date......: 
	' Release...: 
	' Overview..: 
...
Public Sub GetGroupCatName(groupCatType As Int) As String
	Dim groupCatName As String = "Group category not found!"
...
Public Sub GetMainCatName(mainCatType As Int) As String
	Dim mainCatName As String = "Main category not found!"
...
Public Sub GetSizeOptName(sizeOptType As Int) As String
	Dim sizeOptionName As String = "Unknown size"
...
' Get the size text for a specified sizePrice value
Public Sub GetSizeTextForSizePriceValue(sizePriceId As Int) As String
	Dim mSizePriceRec As clsSizePriceTableRec = GetSizePriceRec(sizePriceId)
	Return GetSizeOptName(mSizePriceRec.size)
End Sub
...
'  Return name as string, "" if not found
...
' Returns List (of sizePriceTableRec) - See modEposApp for definition user type "sizePriceTableRec".
