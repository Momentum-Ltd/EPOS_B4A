...
Sub Class_Globals
	...
	' View declarations
	' Card Entry Panel
	Private btnSubmit As B4XView				' Submit card details button.
	Private btnTestData As B4XView				' Load test card data.
...
Public Sub ResumeOp
	btnTestData.Visible = Starter.settings.testMode ' Short cut for setting Test Card button.
	cardInfo.Initialize
End Sub
