...
Sub Class_Globals
	...
	' View declarations
	Private btnCreateNewAccount As B4XView	' Button to invoke create new customer account.
	Private btnMoveAccount As B4XView		' Button to move an existing account to this device.	
