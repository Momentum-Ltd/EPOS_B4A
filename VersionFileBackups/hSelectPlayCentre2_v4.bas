...
#Region  Documentation
	...
	'			  Mod: StartLocationUpdates() Displacement changed and SetFastestInterval removed. 
	'			  Mod: clvCentres_ItemClick() fixed warning about objects.
	'			  Bugfix: DisplayOnListview() - object saved correctly for end of list.
	'
	' Date......: 
	' Release...: 
	' Overview..:
