...
Sub Process_Globals
	...
	' Public constants for distance
	''' <summary>
	''' Centre distance unknown.
	''' </summary>
	''' <remarks>This value is usually returned with not customer position is not available.</remarks>
	Public Const CENTRE_DISTANCE_UNKNOWN As Float = -1

	''' <summary>
	''' Centre distance not applicable.
	''' </summary>
	''' <remarks>This value is usually returned for the distance to the Demo centre.</remarks>
	Public Const CENTRE_DISTANCE_NA As Float = -2
