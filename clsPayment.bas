...
'Public Sub Initialize(progressbox As clsProgress)
'
'
'End Sub
'
...
'Public Sub QueryPaymentAfterFailure(paymentInfo As clsEposCustomerPayment)
'	Dim confirmMsg As String = GetPaymentConfirmMsg(paymentInfo.status)
'#if B4A
...
'End Sub
'
'' Query and invoke payment method (Saved card | Another card | Cash).
'Public Sub QueryPaymentMethod(orderPayment As clsOrderPaymentRec)
'	Dim msg As String
...
'
'
'Public Sub ReportPaymentResult(paymentInfo As clsEposCustomerPayment)
'	
'End Sub
'
'
